...
class UserOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_order" do
    assert_difference('UserOrder.count') do
      post user_orders_url, params: { user_order: { bulk_order_id: @user_order.bulk_order_id, item: @user_order.item, user_id: @user_order.user_id } }
    end
  ...
  test "should update user_order" do
    patch user_order_url(@user_order), params: { user_order: { bulk_order_id: @user_order.bulk_order_id, item: @user_order.item, user_id: @user_order.user_id } }
